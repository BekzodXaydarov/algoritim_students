...
export class UpdateStudentDto {
  ...
  @ApiProperty({
    ...
    description: 'What you liked the most',
  })
  @IsString({ message: 'Liked must be a string' })
  readonly liked: string;

  @ApiProperty({
    example: 'Better quality education',
    description: 'What you wish to improve',
  })
  @IsString({ message: 'Wish must be a string' })
  readonly wish: string;

  @ApiProperty({
    example: 'High-quality education',
    description: 'Reason for studying here',
  })
  ...
  @ApiProperty({
    example: 'Not sure',
    description: 'Future plans according to your parents',
  })
  ...
  @ApiProperty({
    ...
    description: 'Discussion with parents about courses',
  })
  ...
  @ApiProperty({
    ...
    description: 'What you like about your teacher',
  })
  ...
  @ApiProperty({
    ...
    description: 'Plans after certification',
  })
  ...
  @ApiProperty({
    example: '1 month',
    description: 'Duration of study at the center',
  })
  ...
  @ApiProperty({
    example: 'abdulazizikromov09@gmail.com',
  ...
  @IsDate({ message: 'Birth date must be a valid date' }) // Added date validation
